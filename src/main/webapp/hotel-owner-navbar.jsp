			...
			<div class="collapse navbar-collapse" id="navbarButtonsExample">
				...
				<ul class="navbar-nav me-auto mb-2 mb-lg-0">
					<li class="nav-item"><a class="nav-link" href="#">Hotel
							Management System - Hotel Owner</a></li>
				</ul>


				<!-- Left links -->
				<div class="d-flex align-items-center" style="padding:10px">
					<a data-mdb-ripple-init class="btn btn-dark px-3" href="home-hotel-owner.jsp"
						role="button">Display Hotels </a>
				</div>
				<div class="d-flex align-items-center"style="padding:10px">
					<a data-mdb-ripple-init class="btn btn-dark px-3" href="hotel-register.jsp"
						role="button">Add More Hotels </a>
				</div>
